...
/**
 * The primary key class for the INSTITUICAO_FONE database table.
 * 
 */
@Embeddable
public class InstituicaoFonePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof InstituicaoFonePK)) {
			return false;
		}
		InstituicaoFonePK castOther = (InstituicaoFonePK)other;
		return 
