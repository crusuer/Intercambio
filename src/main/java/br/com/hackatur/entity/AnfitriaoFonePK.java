...
/**
 * The primary key class for the ANFITRIAO_FONE database table.
 * 
 */
@Embeddable
public class AnfitriaoFonePK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof AnfitriaoFonePK)) {
			return false;
		}
		AnfitriaoFonePK castOther = (AnfitriaoFonePK)other;
		return 
